...
function LinearProgrammingmax() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch("http://localhost:5000/lp_max", {
        method: "POST",
  ...
  return (
    <div className="py-36 max-w-3xl mx-auto text-white">
      <h2 className="text-center text-xl font-bold mb-4">Pemrograman Linear - Maximasi</h2>

      <div className="mb-6">
        <h3 className="text-lg font-semibold mb-2">Fungsi Tujuan (Max)</h3>
